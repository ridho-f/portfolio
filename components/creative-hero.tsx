        ...
        >
          ...
          <div
            ...
            style={{
              ...
              boxShadow:
                glowIntensity > 0
                  ? `0 0 ${20 + glowIntensity * 10}px rgba(51, 155, 94, ${0.5 + glowIntensity * 0.1})`
                  : "none",
            }}
          >
          ...
          <div className="absolute bottom-0 right-0 flex items-center gap-2 bg-black/70 backdrop-blur-sm rounded-full px-3 py-1">
            <div
              ...
              style={{
                boxShadow:
                  glowIntensity > 0
                    ? `0 0 ${5 + glowIntensity * 2}px #10b981`
                    : "none",
              }}
            ></div>
          ...
          <div
            ...
            style={{
              ...
              textShadow:
                glowIntensity > 0
                  ? `0 0 ${5 + glowIntensity * 3}px currentColor`
                  : "none",
            }}
          >
            {"<>"}
